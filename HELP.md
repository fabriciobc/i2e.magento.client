...
* The following dependencies are not known to work with Spring Native: 'Spring for RabbitMQ, Spring Batch, Spring Web Services'. As a result, your application may not work as expected.
...
```
$ docker run --rm i2e.magento.client:0.0.1-SNAPSHOT
```
